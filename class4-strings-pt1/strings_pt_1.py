...
# Concatenating
hours =str(hours) # we are casting integer to string
# print('There are '+ hours +' hours in a day' )
...
letter_e = day.find('e')
# print(letter_e)
# print(f'The letter e appears at the {letter_e} positions in {day}')

# Find position of J in month
letter_j = month.find('J')
# print(letter_j)
# print(f'The letter j appears at the {letter_j} positions in {month}')

# Find the position of R in movie
letter_r = movie.find('R')
# print(f'The letter r appears at the {letter_r} position in {movie}')
...
# print (f'The letter b appears at the {letter_b} position in {movie}')
...
# print(f'Hello, {first_name}, I am counting {length_of_name} character')
...
# user_num = input("Hello, what is yuor number? ")

# FIND IF WORD IS LONGER THAN THE NUMBER
